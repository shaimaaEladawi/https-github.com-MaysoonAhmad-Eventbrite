...
namespace WebMVC.Controllers
{
    public class CatalogController : Controller
    {
        ...
        public async Task<IActionResult> Index( int? page, int? categoryFilterApplied,
            ...
            int? typesFilterApplied, int? locationFilterApplied)
...

        {
            ...
            var catalog = await _service.GetCatalogItemsAsync(page ?? 0,itemsOnPage, categoryFilterApplied, typesFilterApplied, locationFilterApplied);
